    ...
    <div className="welcomeContainer">
      ...
      <div className="whatInfo">
        ...
        <p>
          ...
          up a certain kanji. Information about the Kanji will be displayed such
          as meaning, readings, and example words that use the kanji.
        </p>
        <p>
          Additionally, users can add Kanji to their collection and mark their
          learning status for that particular kanji. This allows users to keep
          track of all the Kanji they are learning or have learned.
        </p>
        <p>
